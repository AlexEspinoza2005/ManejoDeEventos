...
namespace MannejoDeEventos.API.Controllers
{
    ...
    public class PonentesController : ControllerBase
    {
        ...
        public PonentesController(AppHDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Ponente>> PostPonente(Ponente ponente)
        {
            ...
            return CreatedAtAction("GetPonente", new { id = ponente.IdPonente }, ponente);
        }
        ...
        {
            return _context.Ponentes.Any(e => e.IdPonente == id);
        }
    }
}
